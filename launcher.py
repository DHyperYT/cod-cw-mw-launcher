...
class GameLauncher:
    def __init__(self, root):
        ...
        self.mw_img = self.mw_img.resize((45, 45), Image.Resampling.LANCZOS)
        ...
        self.cw_img = self.cw_img.resize((45, 45), Image.Resampling.LANCZOS)
        ...
        self.mw2_img = self.mw2_img.resize((45, 45), Image.Resampling.LANCZOS)
        ...
        self.settings_img = self.settings_img.resize((45, 45), Image.Resampling.LANCZOS)
        ...
        self.mute_img = self.mute_img.resize((45, 45), Image.Resampling.LANCZOS)
        ...
        self.git_img = self.git_img.resize((45, 45), Image.Resampling.LANCZOS)
